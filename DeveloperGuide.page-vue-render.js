...
with(this){return _c('p',[_v("The undo/redo mechanism is implemented within "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBook.java")]),_v(" by saving the entire "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("persons")]),_v(" list. It uses an undo and a redo stack to maintain the history. Additionally, it implements the following operations:")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBook#save()")]),_v(" — Copies the current "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("persons")]),_v(" list into the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undoStack")]),_v(".")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBook#undo()")]),_v(" — Restores the previous "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("persons")]),_v(" list state from the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undoStack")]),_v(".")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBook#redo()")]),_v(" — Restores a previously undone "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("persons")]),_v(" list state from the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("redoStack")]),_v(".")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("save()")]),_v(" is used within the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBook")]),_v(" class methods, saving only when the persons list is about to be modified. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("save()")]),_v(" is set to be private to prevent potential misuse from other classes, and Law of Demeter violations.")])}
},function anonymous(
) {
with(this){return _c('p',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undo")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("redo")]),_v(" are exposed in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" interface as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#undo()")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#redo()")]),_v(" respectively.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 1. The user launches the application for the first time. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("persons")]),_v(" list will be initialized with the initial address book state (State 0), with the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undoStack")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("redoStack")]),_v(" empty.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 2. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 5")]),_v(" command to delete the 5th person in the address book. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(" command calls several other functions until it calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("save()")]),_v(". This causes the state of the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("persons")]),_v(" list "),_c('strong',[_v("before")]),_v(" the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 5")]),_v(" command is executed (State 0) to be saved into the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undoStack")]),_v(". The 5th person is then removed from the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("persons")]),_v(" list (State 1).")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 3. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/David …​")]),_v(" to add a new person. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add")]),_v(" command also calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("save()")]),_v(", causing another "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("persons")]),_v(" list state (State 1) to be saved into the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undoStack")]),_v(", before adding the person (State 2).")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 4. The user now decides that adding the person was a mistake, and decides to undo that action by executing the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undo")]),_v(" command. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undo")]),_v(" command will call "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#undo()")]),_v(", which will:")])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Copy the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("persons")]),_v(" list (State 2) into the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("redoStack")]),_v(".")]),_v(" "),_c('li',[_v("Pop the latest "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("persons")]),_v(" list state (State 1) from the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undoStack")]),_v(".")]),_v(" "),_c('li',[_v("Copy this popped state (State 1) into the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("persons")]),_v(" list.")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("Notice that the states are copied into the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("persons")]),_v(" list instead of replacing it, resulting in the exact same object being used. This is to prevent synchronization issues and to reduce coupling with the GUI, allowing the GUI to use this same list object throughout the program's life.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("redo")]),_v(" command does the opposite — it calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#redo()")]),_v(", which will:")])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Copy the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("persons")]),_v(" list into the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undoStack")]),_v(".")]),_v(" "),_c('li',[_v("Pop the latest "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("persons")]),_v(" list state from the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("redoStack")]),_v(".")]),_v(" "),_c('li',[_v("Copy this popped state into the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("persons")]),_v(" list.")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 5. The user then decides to execute the command "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(". Commands that do not modify the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("persons")]),_v(" list, such as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(", will usually not call "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBook#save()")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#undo()")]),_v(" or "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#redo()")]),_v(". Thus, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undoStack")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("redoStack")]),_v(" remains unchanged.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 6. The user executes "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clear")]),_v(", which calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBook#save()")]),_v(".\nSince there are still states in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("redoStack")]),_v(", all states in the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("redoStack")]),_v(" will be removed.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Reason: It no longer makes sense to redo the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/David …​")]),_v(" command and ignore the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("clear")]),_v(" command. This is the behavior that most modern desktop applications follow.")])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Alternative 1 (selected choice):")]),_v(" Save the entire address book as objects.\n"),_c('ul',[_c('li',[_v("Pros:\n"),_c('ul',[_c('li',[_v("Easy to implement.")]),_v(" "),_c('li',[_v("Unlikely to have bugs.")])])]),_v(" "),_c('li',[_v("Cons:\n"),_c('ul',[_c('li',[_v("May have performance issues in terms of memory usage.")])])])])])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Alternative 2:")]),_v(" Save the entire address book into storage as JSON files.\n"),_c('ul',[_c('li',[_v("Pros:\n"),_c('ul',[_c('li',[_v("Saves history between different program launches.")])])]),_v(" "),_c('li',[_v("Cons:\n"),_c('ul',[_c('li',[_v("May have performance issues with many storage accesses.")]),_v(" "),_c('li',[_v("Increases coupling as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model")]),_v(" will now need a reference to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage")]),_v(".")])])])])])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Alternative 3:")]),_v(" Save the entire address book as a JSON "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("String")]),_v(" in RAM.\n"),_c('ul',[_c('li',[_v("Pros:\n"),_c('ul',[_c('li',[_v("Reduces memory footprint as only 1 String is used as compared to a many objects per Person.")]),_v(" "),_c('li',[_v("Faster than JSON files as there are no accesses to storage.")])])]),_v(" "),_c('li',[_v("Cons:\n"),_c('ul',[_c('li',[_v("May have performance issues as it has to be deserialized each time.")])])])])])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Alternative 4:")]),_v(" Each command implements their own specific "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undo()")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("redo()")]),_v(" methods\n"),_c('ul',[_c('li',[_v("Pros:\n"),_c('ul',[_c('li',[_v("Will use less memory (e.g. for "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(", just save the person being deleted).")]),_v(" "),_c('li',[_v("Best performance.")])])]),_v(" "),_c('li',[_v("Cons:\n"),_c('ul',[_c('li',[_v("We must ensure that the implementation of each individual "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undo")]),_v(" command is correct.\nThis would be especially difficult for commands that modify multiple people at once (e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("asset")]),_v(" editing commands)")])])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Aspect: Data structure used to store undo & redo states:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Alternative 1 (selected choice):")]),_v(" 2 Stacks.\n"),_c('ul',[_c('li',[_v("Pros:\n"),_c('ul',[_c('li',[_v("Easy to implement.")]),_v(" "),_c('li',[_v("Simple data structure.")]),_v(" "),_c('li',[_v("Easy to clear all redo states.")])])]),_v(" "),_c('li',[_v("Cons:\n"),_c('ul',[_c('li',[_v("May have performance issues if many redo states are cleared at once.")])])])])])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Alternative 2:")]),_v(" ArrayList, using pointers for current state and redo limit.\n"),_c('ul',[_c('li',[_v("Pros:\n"),_c('ul',[_c('li',[_v("Redo states no longer have to be cleared, as they are tracked by pointers and can be replaced at indexes as needed.")])])]),_v(" "),_c('li',[_v("Cons:\n"),_c('ul',[_c('li',[_v("Harder to implement.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add()")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("set()")]),_v(" have to be used appropriately to prevent synchronization issues.")]),_v(" "),_c('li',[_v("Pointers have to be carefully implemented.")])])])])])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Alternative 3:")]),_v(" LinkedList.\n"),_c('ul',[_c('li',[_v("Pros:\n"),_c('ul',[_c('li',[_v("Fast in dropping many nodes after a specified index.")]),_v(" "),_c('li',[_v("Simple data structure.")])])]),_v(" "),_c('li',[_v("Cons:\n"),_c('ul',[_c('li',[_v("Time-consuming to implement: Unfortunately, the built-in LinkedList does not have a method to drop all nodes after a certain index.\nHence a custom data structure would have to be used in order to quickly drop nodes after a certain index.\nThere would be no benefits of using a LinkedList here otherwise.")])])])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.3.0")]),_v(", generated on Thu, 28 Mar 2024, 12:22:45 GMT+8]")])])])}
}];
